...
;            }
    ...
    function sync(method, object, options) {
        ...
        var schema = object.database || (object.collection ? object.collection.database : undefined);

        // If a model or a collection does not define a database, fall back on ajaxSync
        if (typeof schema === 'undefined' && typeof Backbone.ajaxSync === 'function'){
        ...
        options.success = function(resp) {
            resolve();
            if (success) success(resp, object, resp, options);
